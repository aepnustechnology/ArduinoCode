/* H2Only EZO Circuit Calibration Arduino Firmware
   by Matt Garfield (matt.garfield@nextfab.com)
   7/15/2019

   modified from: https://www.atlas-scientific.com/_files/code/Ardunio-I2C-pH-sample-code.pdf
*/

#include <Wire.h>                //enable I2C.

//Uncomment the line for the device to communicate with:
//---------------------------------------------------
//#define address    99          // EZO-PH default I2C address
//#define address     100       // PHAB //  EZO-EC default I2C address
//#define address     101       // ECAB
//#define address     102       // PHA2
//#define address     103       // ECA2 // EZO-PMP default I2C address
//#define address     104       // PHB2
//#define address     105       // ECB2
//#define address     106       // Pump A
//#define address     107       // Pump B
#define address     1       // Pump C
//#define address     109       // Pump D
//#define address     110       // Pump E

#define VERSION       "v1.0.0"
#define PC_BAUD        115200     // PC Serial BAUD rate

char computerdata[20];           //we make a 20 byte character array to hold incoming data from a pc/mac/other.
byte received_from_computer = 0; //we need to know how many characters have been received.
byte serial_event = 0;           //a flag to signal when data has been received from the pc/mac/other.
byte code = 0;                   //used to hold the I2C response code.
char data[20];                //we make a 20 byte character array to hold incoming data from the pH circuit.
byte in_char = 0;                //used as a 1 byte buffer to store inbound bytes from the pH Circuit.
byte i = 0;                      //counter used for data array.
int time_ = 815;                 //used to change the delay needed depending on the command sent to the EZO Class pH Circuit.
float data_float;                  //float var used to hold the float value of the pH.


void setup()                     //hardware initialization.
{
  Serial.begin(PC_BAUD);         //enable serial port.
  Wire.begin();                 //enable I2C port.

  Serial.print( F("-- H2Only EZO Circuit Calibration "));
  Serial.print( F(VERSION));                    // print version number of firmware from #define
  Serial.println( F(" --\n\r"));
  Serial.println( F("Command Options:"));  
  Serial.println(F("\t* 'i' to test communication"));
  Serial.println( F("------------------\n\r"));
