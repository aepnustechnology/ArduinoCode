...
//#define NUM_CIRCUITS 1

#define baud_host 9600              // set baud rate for host serial monitor(pc/mac/other)
const unsigned int send_readings_every = 1000; // set at what intervals the readings are sent to the computer (NOTE: this is not the frequency of taking the readings!)
...
char *channel_names[] = {"PH1", "EC1"};   // <-- CHANGE THIS. A list of channel names (this list should have TOTAL_CIRCUITS entries)
//char *channel_names[] = {"PH"};
