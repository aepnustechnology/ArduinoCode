...
// ---------------
  ...
  #define SEND_TO_PC_INTERVAL_MS  1990       // 1990 ms (2 sec) test - interval the readings are sent to the computer (NOTE: this is not the frequency of taking the readings!)
  ...
  #define NUM_EZO_PUMPS           5         // number of EZO circuits attached to the Tentacle
  //Ezo_board(uint8_t i2c_address, const char* name); 
